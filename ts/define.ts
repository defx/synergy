...
//@todo: separate vm data and lifecycle events so that we can type them properly :P

interface SynergyElement {
  viewmodel: { [key: string]: any };
}
